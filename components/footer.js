  ...
  <div class="container d-flex justify-content-between">
    ...
    <div class="cred-rea">
      <!-- Comente em caso de adaptação do REA -->
        ...
        <div><a href="https://github.com/univesp/meu-passaporte-cientifico" target="_blank" aria-label="GitHub" style="white-space:nowrap;">GitHub <i class="fab fa-github"></i></a></div>
    ...
    <div class="aval-rea d-flex">
      <!-- AVALIAR RECURSO -->
      <!-- Criar formulario no Office Forms -->
      <a class="btn btn-secondary" href="https://forms.office.com/r/xti65YUL45" target="_blank">Avaliar este recurso</a>
